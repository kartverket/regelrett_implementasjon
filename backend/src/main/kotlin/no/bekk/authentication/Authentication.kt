...
suspend fun getGroupsOrEmptyList(call: ApplicationCall): List<MicrosoftGraphGroupIdAndDisplayName> {
    ...
    return microsoftService.fetchGroupsWithIdAndNames(graphApiToken)
}
...
suspend fun hasTeamAccess(call: ApplicationCall, teamId: String?): Boolean {
    ...
    return teamId in groups.map { it.displayName }
}
