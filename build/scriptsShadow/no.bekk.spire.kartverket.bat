...
set CLASSPATH=%APP_HOME%\lib\no.bekk.spire.kartverket-all.jar

@rem Execute no.bekk.spire.kartverket
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NO_BEKK_SPIRE_KARTVERKET_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NO_BEKK_SPIRE_KARTVERKET_EXIT_CONSOLE%" exit 1
exit /b 1
