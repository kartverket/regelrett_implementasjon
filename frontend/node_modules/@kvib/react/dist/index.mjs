import { forwardRef, Alert as Alert$1, Badge as Badge$1, Button as Button$1, Center, Spinner, HStack, IconButton as IconButton$1, ButtonGroup as ButtonGroup$1, Card as Card$1, FormControl as FormControl$1, FormLabel as FormLabel$1, FormHelperText as FormHelperText$1, FormErrorMessage as FormErrorMessage$1, Link as Link$1, NumberInput as NumberInput$1, NumberInputField as NumberInputField$1, NumberInputStepper as NumberInputStepper$1, PinInputField as PinInputField$1, useDimensions, Tabs as Tabs$1, defineStyleConfig, defineStyle, createMultiStyleConfigHelpers, extendTheme, withDefaultColorScheme, Input, useTheme, useFormControlContext, useBoolean, Popover, InputGroup, PopoverAnchor, InputRightElement, PopoverTrigger, PopoverContent, useStyleConfig, AbsoluteCenter, Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, AlertDescription, AlertDialog, AlertDialogBody, AlertDialogCloseButton, AlertDialogContent, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, AlertIcon, AlertTitle, AspectRatio, Avatar, AvatarBadge, AvatarGroup, Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbSeparator, CardBody, CardFooter, CardHeader, Checkbox, CheckboxGroup, Circle, CircularProgress, CircularProgressLabel, CloseButton, Code, Collapse, Container, Divider, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Editable, EditableInput, EditablePreview, EditableTextarea, Fade, Flex, Grid, GridItem, Heading, Hide, Highlight, Image, InputAddon, InputLeftAddon, InputLeftElement, InputRightAddon, Kbd, LinkBox, LinkOverlay, List, ListIcon, ListItem, Menu, MenuButton, MenuDivider, MenuGroup, MenuItem, MenuItemOption, MenuList, MenuOptionGroup, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, OrderedList, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverFooter, PopoverHeader, Portal, Progress, Radio, RadioGroup, RangeSlider, RangeSliderFilledTrack, RangeSliderMark, RangeSliderThumb, RangeSliderTrack, ScaleFade, Select, Show, SimpleGrid, Skeleton, SkeletonCircle, SkeletonText, Slide, SlideFade, Slider, SliderFilledTrack, SliderMark, SliderThumb, SliderTrack, Spacer, Square, Stack, StackDivider, Stat, StatArrow, StatGroup, StatHelpText, StatLabel, StatNumber, Step, StepDescription, StepIcon, StepIndicator, StepNumber, StepSeparator, StepStatus, StepTitle, Stepper, Switch, Tab, TabList, TabPanel, TabPanels, Table, TableCaption, TableContainer, Tag, TagCloseButton, TagLabel, TagLeftIcon, TagRightIcon, Tbody, Td, Text, Textarea, Tfoot, Th, Thead, Tooltip, Tr, UnorderedList, VStack, VisuallyHidden, VisuallyHiddenInput, Wrap, WrapItem, useBreakpointValue, useClipboard, useConst, useControllableProp, useControllableState, useDisclosure, useMediaQuery, useMergeRefs, useOutsideClick, usePrefersReducedMotion, useSteps, useToast, useToken, NumberIncrementStepper, NumberDecrementStepper, PinInput as PinInput$1, ChakraProvider } from '@chakra-ui/react';
export { AbsoluteCenter, Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, AlertDescription, AlertDialog, AlertDialogBody, AlertDialogCloseButton, AlertDialogContent, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, AlertIcon, AlertTitle, AspectRatio, Avatar, AvatarBadge, AvatarGroup, Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbSeparator, CardBody, CardFooter, CardHeader, Center, Checkbox, CheckboxGroup, Circle, CircularProgress, CircularProgressLabel, CloseButton, Code, Collapse, Container, Divider, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Editable, EditableInput, EditablePreview, EditableTextarea, Fade, Flex, Grid, GridItem, HStack, Heading, Hide, Highlight, Image, Input, InputAddon, InputGroup, InputLeftAddon, InputLeftElement, InputRightAddon, InputRightElement, Kbd, LinkBox, LinkOverlay, List, ListIcon, ListItem, Menu, MenuButton, MenuDivider, MenuGroup, MenuItem, MenuItemOption, MenuList, MenuOptionGroup, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, OrderedList, Popover, PopoverAnchor, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverFooter, PopoverHeader, PopoverTrigger, Portal, Progress, Radio, RadioGroup, RangeSlider, RangeSliderFilledTrack, RangeSliderMark, RangeSliderThumb, RangeSliderTrack, ScaleFade, Select, Show, SimpleGrid, Skeleton, SkeletonCircle, SkeletonText, Slide, SlideFade, Slider, SliderFilledTrack, SliderMark, SliderThumb, SliderTrack, Spacer, Spinner, Square, Stack, StackDivider, Stat, StatArrow, StatGroup, StatHelpText, StatLabel, StatNumber, Step, StepDescription, StepIcon, StepIndicator, StepNumber, StepSeparator, StepStatus, StepTitle, Stepper, Switch, Tab, TabList, TabPanel, TabPanels, Table, TableCaption, TableContainer, Tag, TagCloseButton, TagLabel, TagLeftIcon, TagRightIcon, Tbody, Td, Text, Textarea, Tfoot, Th, Thead, Tooltip, Tr, UnorderedList, VStack, VisuallyHidden, VisuallyHiddenInput, Wrap, WrapItem, extendTheme, forwardRef, useBoolean, useBreakpointValue, useClipboard, useConst, useControllableProp, useControllableState, useDimensions, useDisclosure, useMediaQuery, useMergeRefs, useOutsideClick, usePrefersReducedMotion, useSteps, useTheme, useToast, useToken, withDefaultColorScheme } from '@chakra-ui/react';
import { jsx, jsxs } from 'react/jsx-runtime';
import * as material_symbols_star from 'material-symbols';
...
import { useInput, DayPicker } from 'react-day-picker';
import 'react-day-picker/dist/style.css';
import { nb } from 'date-fns/locale/nb';
import { parse, isValid } from 'date-fns';
import { AsyncSelect } from 'chakra-react-select';
import { useTimeFieldState } from 'react-stately';
import { useTimeField, useDateSegment } from 'react-aria';
...
var Alert = forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx(Alert$1, __spreadProps(__spreadValues({}, props), { ref }));
});
var Badge = forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(Badge$1, __spreadProps(__spreadValues({}, props), { ref }));
});
...
// src/icon/index.ts
__reExport(icon_exports, material_symbols_star);
var Button = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs(Button$1, __spreadProps(__spreadValues({}, props), { ref, isDisabled: isDisabled || isLoading, "aria-busy": isLoading, children: [
      isLoading && /* @__PURE__ */ jsx(Center, { position: "absolute", right: "0", left: "0", children: /* @__PURE__ */ jsx(Spinner, { size: "sm" }) }),
      /* @__PURE__ */ jsxs(HStack, { spacing: 1, visibility: isLoading ? "hidden" : "visible", children: [
        ...
        /* @__PURE__ */ jsx(Center, { className: "text", as: "span", children }),
...
var ButtonGroup = forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(ButtonGroup$1, __spreadProps(__spreadValues({}, props), { ref }));
});
var Card = forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(Card$1, __spreadProps(__spreadValues({}, props), { ref }));
});
...
var FormLabel = forwardRef((_a, ref) => {
  var _b = _a, { label, children } = _b, props = __objRest(_b, ["label", "children"]);
  return /* @__PURE__ */ jsxs(FormLabel$1, __spreadProps(__spreadValues({}, props), { ref, fontWeight: "bold", children: [
    label,
    children
  ] }));
});
var FormHelperText = forwardRef((_a, ref) => {
  var _b = _a, { helperText, children } = _b, props = __objRest(_b, ["helperText", "children"]);
  return /* @__PURE__ */ jsxs(FormHelperText$1, __spreadProps(__spreadValues({}, props), { ref, fontSize: "16px", paddingBottom: "8px", children: [
    helperText,
    children
  ] }));
});
...
var NumberInput = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsx(NumberInput$1, __spreadProps(__spreadValues({}, props), { ref, isInvalid, isDisabled, children }));
  }
);
var NumberInputField = forwardRef((_a, ref) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx(NumberInputField$1, __spreadProps(__spreadValues({}, props), { ref, children }));
});
var NumberInputStepper = forwardRef((_a, ref) => {
  var _b = _a, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsxs(NumberInputStepper$1, __spreadProps(__spreadValues({}, props), { ref, children: [
...
var PinInput = (_a) => {
  ...
  return /* @__PURE__ */ jsx(PinInput$1, __spreadProps(__spreadValues({}, props), { size, children }));
};
var PinInputField = forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(PinInputField$1, __spreadProps(__spreadValues({}, props), { ref }));
});
var KvibProvider = (_a) => {
  var _b = _a, { theme = defaultKvibTheme, children } = _b, props = __objRest(_b, ["theme", "children"]);
  return /* @__PURE__ */ jsx(ChakraProvider, __spreadProps(__spreadValues({}, props), { theme, children }));
};
var Search = forwardRef(
  (_a, ref) => {
    ...
    const RenderButton = ({ position: position2 }) => {
      ...
      return buttonText ? /* @__PURE__ */ jsx(Button, __spreadProps(__spreadValues({ ref: elementRef }, buttonProps), { rightIcon: "search", type: "submit", "aria-label": "search", children: buttonText })) : /* @__PURE__ */ jsx(IconButton, __spreadProps(__spreadValues({}, buttonProps), { "aria-label": "search", type: "submit", icon: "search" }));
    };
    ...
    const RenderInputGroup = () => /* @__PURE__ */ jsxs(InputGroup, { size, width: props.width, children: [
      /* @__PURE__ */ jsx(
        Input,
        __spreadProps(__spreadValues({}, props), {
          id,
      ...
      searchButton === "left" && /* @__PURE__ */ jsx(InputLeftElement, { width: "auto", children: /* @__PURE__ */ jsx(RenderButton, { position: "left" }) }),
      searchButton === "right" && /* @__PURE__ */ jsx(InputRightElement, { width: "auto", children: /* @__PURE__ */ jsx(RenderButton, { position: "right" }) })
    ] });
    return /* @__PURE__ */ jsx(RenderInputGroup, {});
  }
);
var Tabs = forwardRef((_a, ref) => {
  var _b = _a, { size = "md" } = _b, props = __objRest(_b, ["size"]);
  return /* @__PURE__ */ jsx(Tabs$1, __spreadProps(__spreadValues({ size }, props), { ref }));
});
...
var helpers = createMultiStyleConfigHelpers(tabsAnatomy.keys);
...
var iconButtonTheme = defineStyleConfig({
...
var inputTheme = defineStyleConfig({
  baseStyle: {
...
var baseStyle3 = defineStyle((props) => {
  const { colorScheme: c } = props;
  return {
    control: {
      borderColor: `${c}.500`,
...
var checkboxTheme = defineStyleConfig({
  baseStyle: baseStyle3
});
var numberInputTheme = defineStyleConfig({
  baseStyle: {
    // Any base styles should go directly here
  },
  variants: {
...
var baseStyle4 = defineStyle((props) => {
  const { colorScheme: c } = props;
  return {
    control: {
      borderColor: `${c}.500`,
...
var radioTheme = defineStyleConfig({
  baseStyle: baseStyle4
});
var baseStyle5 = defineStyle((props) => {
  return {
    track: {
      bg: "gray.400"
    },
...
var sliderTheme = defineStyleConfig({
  baseStyle: baseStyle5
});
var switchTheme = defineStyleConfig({
  baseStyle: ({ colorScheme }) => ({
    track: {
      bg: "gray.400",
      // Border color when unchecked
...
var baseStyle6 = defineStyle((props) => {
  const { colorScheme: c } = props;
  return {
    bg: "transparent",
    color: "black",
...
var timepickerTheme = defineStyleConfig({
...
var fileUploadTheme = defineStyleConfig({
  sizes: sizes2,
  defaultProps: {
    size: "md"
  }
});
var { defineMultiStyleConfig } = createMultiStyleConfigHelpers(alertAnatomy.keys);
...
var variantLeftAccent = defineStyle((props) => {
  const { status: s } = props;
  if (s === "error") {
    return {
      title: {
...
var variantTopAccent = defineStyle((props) => {
  const { status: s } = props;
  if (s === "error") {
    return {
      title: {
...
var datepickerTheme = defineStyleConfig({
  defaultProps: {
    colorScheme: "green"
  }
});
...
// src/theme/index.ts
var defaultKvibTheme = extendTheme(
...
var Datepicker = forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx(CustomDatepicker, __spreadProps(__spreadValues(__spreadValues({}, props), commonProps), { onChange }));
});
var CustomDatepicker = forwardRef(
  (_a, ref) => {
    var _b = _a, {
      onChange,
      defaultSelected,
      ...
      Popover,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(InputGroup, { children: [
            ...
            /* @__PURE__ */ jsx(InputRightElement, { opacity: isDisabled ? 0.5 : 1, pointerEvents: isDisabled ? "none" : "auto", height: "100%", children: /* @__PURE__ */ jsx(PopoverTrigger, { children: /* @__PURE__ */ jsx(
              IconButton,
              {
                icon: "calendar_today",
                colorScheme,
          ...
          /* @__PURE__ */ jsxs(PopoverContent, { width: "auto", padding: "1rem", children: [
...
var Logo = ({ variant = "vertical", size, label }) => {
  ...
  if (variant === "horizontal") {
    return /* @__PURE__ */ jsx(LogoHorizontal, { label, width, height });
  }
  return /* @__PURE__ */ jsx(LogoVertical, { label, width, height });
};
...
var SearchAsyncNoRef = ({
  ...
  const noOptionsMessageDefault = ({ inputValue }) => {
    ...
    return /* @__PURE__ */ jsx(Text, { children: "Fant ingen resultater" });
  };
  ...
  return /* @__PURE__ */ jsx(
    AsyncSelect,
    {
      ...
      loadingMessage: () => /* @__PURE__ */ jsx(Text, { children: "Laster..." }),
...
var FooterToggleableFlex = (props) => {
  if (props.hidden)
    return null;
  return /* @__PURE__ */ jsx(Flex, __spreadProps(__spreadValues({ flexDir: props.flexDir || "column", gap: 1, flex: 1 }, props), { children: props.children }));
};
var Footer = ({
  accessibilityUrl,
  excludeContactInfo,
  ...
  return /* @__PURE__ */ jsx(Box, { marginTop: "auto", alignSelf: "flex-end", w: "full", py: "12", px: "6", bg: "#f5f2f2", borderTop: "8px solid #1a833b", children: /* @__PURE__ */ jsxs(Flex, { flexDir: "column", gap: 8, maxWidth: 1200, mx: "auto", children: [
    /* @__PURE__ */ jsxs(Flex, { alignItems: "flex-start", justifyContent: "space-between", gap: 10, flexWrap: "wrap", children: [
      /* @__PURE__ */ jsx(Logo, { size: 200, variant: "horizontal" }),
      /* @__PURE__ */ jsxs(Flex, { gap: 8, flex: "1", flexWrap: "wrap", children: [
        /* @__PURE__ */ jsxs(Flex, { gap: 8, flexDir: onlyOneIncluded ? "row" : "column", justify: "space-between", children: [
          /* @__PURE__ */ jsxs(FooterToggleableFlex, { hidden: excludeContactInfo, children: [
            /* @__PURE__ */ jsx(Heading, { size: "md", pb: 2, children: "Kontakt oss" }),
            /* @__PURE__ */ jsxs(Text, { children: [
              "Telefon:",
              " ",
              /* @__PURE__ */ jsxs(Link, { fontWeight: "bold", "aria-label": "Ring Kartverket p\xE5 telefon", href: "tel:32118000", children: [
                " ",
                "32 11 80 00",
                " "
              ] })
          ...
          /* @__PURE__ */ jsxs(FooterToggleableFlex, { hidden: excludeOpeningHours, children: [
            /* @__PURE__ */ jsx(Text, { fontWeight: "bold", children: " \xC5pningstider (mandag-fredag) " }),
            /* @__PURE__ */ jsx(Text, { children: " Kundesenter/sentralbord: 09.00-15.00 " }),
            /* @__PURE__ */ jsx(Text, { children: " Resepsjon: 08.00-15.00 " })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(FooterToggleableFlex, { hidden: excludeHelp, children: [
          /* @__PURE__ */ jsx(Heading, { size: "md", children: " Hjelp " }),
          /* @__PURE__ */ jsxs(
            Link,
            {
        ...
        /* @__PURE__ */ jsxs(FooterToggleableFlex, { hidden: excludeNews, children: [
          /* @__PURE__ */ jsx(Heading, { size: "md", children: " Aktuelt " }),
          /* @__PURE__ */ jsxs(
            Link,
            {
    ...
    /* @__PURE__ */ jsx(Divider, { opacity: "1", borderColor: "gray.400" }),
    /* @__PURE__ */ jsxs(Flex, { align: "center", justify: "space-between", gap: 10, flexWrap: "wrap", children: [
      excludeSocialMedia ? /* @__PURE__ */ jsx(Box, {}) : /* @__PURE__ */ jsxs(FooterToggleableFlex, { align: "center", gap: 3, flexWrap: "wrap", flexDir: "row", children: [
        /* @__PURE__ */ jsx(Heading, { size: "md", children: " F\xF8lg oss: " }),
        /* @__PURE__ */ jsx(
          Link,
          {
      ...
      /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 3, flexWrap: "wrap", children: [
        /* @__PURE__ */ jsx(
          Link,
          {
        ...
        accessibilityUrl && /* @__PURE__ */ jsxs(Link, { href: accessibilityUrl, "aria-label": "Bes\xF8k denne sidens tilgjengelighetserkl\xE6ring", fontWeight: "bold", children: [
          " ",
  ...
  return /* @__PURE__ */ jsxs(Box, { children: [
    /* @__PURE__ */ jsxs(
      Flex,
      {
        ...
        gap,
        children: [
          /* @__PURE__ */ jsx(Link, { href: logoLink, isExternal: false, children: /* @__PURE__ */ jsx(
            Logo,
            {
              label: logoAltText,
              variant: logoVariant,
          ...
          showMenuButtonElement && /* @__PURE__ */ jsx(IconButton, { "aria-label": "open menu", icon: isOpen ? "close" : "menu", variant: "ghost", onClick: handleClick })
        ]
      }
    ),
    /* @__PURE__ */ jsx(Collapse, { in: isOpen, animateOpacity: false, children: /* @__PURE__ */ jsxs(VStack, { bg: "gray.50", borderBottomWidth: "2px", borderBottomColor: "gray.200", padding: 30, gap: 10, children: [
...
var FooterInline = ({
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      gap: "2rem",
      children: [
        /* @__PURE__ */ jsx(Link, { href: logoLink, isExternal: false, children: /* @__PURE__ */ jsx(Logo, { size: 130, variant: "horizontal" }) }),
        /* @__PURE__ */ jsxs(Flex, { alignItems: "center", gap: "1rem", wrap: "wrap", children: [
          children,
          accessibilityUrl && /* @__PURE__ */ jsx(Link, { href: accessibilityUrl, "aria-label": "Bes\xF8k denne sidens tilgjengelighetserkl\xE6ring", fontWeight: "bold", children: "Tilgjengelighetserkl\xE6ring" }),
          /* @__PURE__ */ jsx(Link, { href: privacyUrl, "aria-label": "Bes\xF8k Kartverket sin personvernserkl\xE6ring", fontWeight: "bold", children: "Personvern" })
        ] })
      ]
    }
  );
...
var DateTimeSegment = (_a) => {
  ...
  return /* @__PURE__ */ jsx(Box, __spreadProps(__spreadValues({}, segmentProps), { ref, paddingX: "1px", outline: "none", borderRadius: "sm", __css: __spreadValues({}, styles), children: isPaddable(segment.type) ? segment.text.padStart(2, "0") : segment.text }));
};
...
var TimeField = (_a) => {
  ...
  const ref = useRef(null);
  const { fieldProps } = useTimeField(props, state2, ref);
  return /* @__PURE__ */ jsxs(Box, { children: [
    /* @__PURE__ */ jsx(Flex, __spreadProps(__spreadValues({}, fieldProps), { ref, children: state2.segments.map((segment) => /* @__PURE__ */ jsx(DateTimeSegment, { segment, state: state2, colorScheme }, segment.type)) })),
    /* @__PURE__ */ jsx("input", { type: "hidden", value: getTimestampFromTime(state2.value), name: props.name })
  ] });
};
var Timepicker = ({
  size,
  ...
  return /* @__PURE__ */ jsxs(
    Input,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(TimeField, { state: state2, colorScheme }),
        /* @__PURE__ */ jsx(
          IconButton,
          {
...
export { Alert, Badge, Button, ButtonGroup, Card, Datepicker, FileUpload, Footer, FooterInline, FormControl, FormErrorMessage, FormHelperText, FormLabel, Header, Icon, IconButton, KvibProvider, Link, Logo, NumberInput, NumberInputField, NumberInputStepper, PinInput, PinInputField, Search, SearchAsync, Tabs, Timepicker, defaultKvibTheme, getCurrentTime, getTimestampFromTime };
